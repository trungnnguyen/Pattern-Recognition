...
[classLabels,g] = BayesianClassify(model, testData(:,1:2));
...
m{caseNumber,2}=ma;
TruePositive(caseNumber)=ma(1,1);
 TrueNegative(caseNumber)=(ma(2,2)+ma(3,3));
 FalseNegative(caseNumber)=(ma(1,2)+ma(1,3));
 FalsePositive(caseNumber)=(ma(2,1)+ma(3,1));
